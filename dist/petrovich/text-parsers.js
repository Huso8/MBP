...
export function parsePricesFromCardText(text) {
...
export function formatPriceLine(cardText) {
...
export function currentPriceRubles(cardText) {
    const nums = parsePricesFromCardText(cardText);
    if (nums.length === 0)
        return null;
...
export function parseAvailabilityFromCardText(cardText) {
...
//# sourceMappingURL=text-parsers.js.map