...
function parsePricesFromCardText(text: string): string[] {
...
function formatPriceLine(text: string): string {
...
function parseAvailabilityFromCardText(text: string): string {
